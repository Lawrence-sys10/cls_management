...
<?php $__env->startSection('subtitle', 'Manage your land records and allocations'); ?>

<?php $__env->startSection('actions'); ?>
    <a href="<?php echo e(route('chief.lands.create')); ?>" class="btn btn-primary">
    ...
    <div class="stats-grid mb-4">
        ...
        <div class="stat-card">
            <div class="stat-header">
                <div class="stat-info">
                    <h3>Under Dispute</h3>
                    <div class="stat-value"><?php echo e($lands->where('ownership_status', 'under_dispute')->count()); ?></div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            ...
            <div class="header-actions">
                <a href="<?php echo e(route('chief.lands.create')); ?>" class="btn btn-primary btn-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <small class="text-muted">ID: <?php echo e($land->id); ?></small>
                            </td>
                            <td>
                                <div class="text-dark"><?php echo e($land->location); ?></div>
                                <?php if($land->landmark): ?>
                                <small class="text-muted">Near: <?php echo e($land->landmark); ?></small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <div class="text-dark"><?php echo e(number_format($land->area_acres, 2)); ?> acres</div>
                                <small class="text-muted"><?php echo e(number_format($land->area_hectares, 2)); ?> ha</small>
                            </td>
                            <td>
                                <div class="text-dark text-capitalize"><?php echo e(str_replace('_', ' ', $land->land_use)); ?></div>
                                <?php if($land->price): ?>
                                <small class="text-muted">₵<?php echo e(number_format($land->price)); ?></small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php
                                ...
                                <?php if($land->ownership_status === 'allocated' && $land->allocations->count() > 0): ?>
                                <br>
                                <small class="text-muted">Allocations: <?php echo e($land->allocations->count()); ?></small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <div class="text-dark"><?php echo e($land->updated_at->format('M j, Y')); ?></div>
                                <small class="text-muted"><?php echo e($land->updated_at->diffForHumans()); ?></small>
                            </td>
                            <td>
                                <div class="btn-group">
                                    <a href="<?php echo e(route('chief.lands.show', $land)); ?>" class="btn btn-sm btn-outline-primary" title="View Details">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('chief.lands.edit', $land)); ?>" class="btn btn-sm btn-outline-secondary" title="Edit Land">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <?php if($land->ownership_status === 'vacant'): ?>
                                    <a href="<?php echo e(route('chief.allocations.create')); ?>?land_id=<?php echo e($land->id); ?>" class="btn btn-sm btn-outline-success" title="Allocate Land">
                                        <i class="fas fa-handshake"></i>
                                    </a>
                                    <?php endif; ?>
                                    <?php if($land->ownership_status === 'under_dispute'): ?>
                                    <a href="<?php echo e(route('chief.disputes.index')); ?>?land_id=<?php echo e($land->id); ?>" class="btn btn-sm btn-outline-warning" title="View Dispute">
                                        <i class="fas fa-gavel"></i>
                                    </a>
                                    <?php endif; ?>
                                    <!-- Updated: Use delete confirmation page instead of inline form -->
                                    <a href="<?php echo e(route('chief.lands.delete', $land)); ?>" class="btn btn-sm btn-outline-danger" title="Delete Land">
...
<script>
    ...
    function quickAllocate(landId) {
        if(confirm('Are you sure you want to allocate this land?')) {
            window.location.href = "<?php echo e(route('chief.allocations.create')); ?>?land_id=" + landId;
        }
    }

    function viewDisputes(landId) {
        window.location.href = "<?php echo e(route('chief.disputes.index')); ?>?land_id=" + landId;
    }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pprhl\cls_management\resources\views/chiefs/lands/index.blade.php ENDPATH**/ ?>