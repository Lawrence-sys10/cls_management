                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($allocation->client): ?>
                                                            <strong><?php echo e($allocation->client->full_name); ?></strong>
                                                            <br><small class="text-muted"><?php echo e($allocation->client->phone); ?></small>
                                                        <?php else: ?>
                                                    ...
                                                    <td>
                                                        <?php if($allocation->land): ?>
                                                            <strong><?php echo e($allocation->land->location); ?></strong>
                                                            <br><small class="text-muted">Plot: <?php echo e($allocation->land->plot_number); ?></small>
                                                            <br><small class="text-muted"><?php echo e(number_format($allocation->land->area_acres, 2)); ?> acres</small>
                                                        <?php else: ?>
                                                    ...
                                                    <td>
                                                        <?php if($allocation->chief): ?>
                                                            ...
                                                            <br><small class="text-muted"><?php echo e($allocation->chief->community); ?></small>
                                                        <?php else: ?>
                                                            <span class="text-muted">No Chief</span>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td><?php echo e($allocation->allocation_date ? \Carbon\Carbon::parse($allocation->allocation_date)->format('M d, Y') : 'N/A'); ?></td>
                                                    <td>
                                                        <span class="badge 
                                                    ...
                                                    <td><?php echo e($allocation->duration_years ?? 'N/A'); ?></td>
