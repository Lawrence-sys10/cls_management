...
<?php $__env->startSection('title', 'Add New Land'); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('chief.lands.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" 
                                           id="plot_number" name="plot_number" value="<?php echo e(old('plot_number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="area_acres" name="area_acres" value="<?php echo e(old('area_acres')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="area_hectares" name="area_hectares" value="<?php echo e(old('area_hectares')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="residential" <?php echo e(old('land_use') == 'residential' ? 'selected' : ''); ?>>Residential</option>
                                        <option value="commercial" <?php echo e(old('land_use') == 'commercial' ? 'selected' : ''); ?>>Commercial</option>
                                        <option value="agricultural" <?php echo e(old('land_use') == 'agricultural' ? 'selected' : ''); ?>>Agricultural</option>
                                        <option value="industrial" <?php echo e(old('land_use') == 'industrial' ? 'selected' : ''); ?>>Industrial</option>
                                        <option value="recreational" <?php echo e(old('land_use') == 'recreational' ? 'selected' : ''); ?>>Recreational</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control <?php $__errorArgs = ['registration_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('registration_date', now()->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="landmark" name="landmark" value="<?php echo e(old('landmark')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                   id="coordinates" name="coordinates" value="<?php echo e(old('coordinates')); ?>" 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pprhl\cls_management\resources\views/chiefs/lands/create.blade.php ENDPATH**/ ?>