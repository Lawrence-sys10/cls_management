...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-6">
            <h1>Documents for <?php echo e($land->plot_number); ?></h1>
            <p class="text-muted"><?php echo e($land->location); ?> • <?php echo e($land->chief->name); ?></p>
        </div>
        <div class="col-md-6 text-end">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#uploadDocumentModal">
                <i class="fas fa-upload"></i> Upload Document
            </button>
            <a href="<?php echo e(route('lands.show', $land)); ?>" class="btn btn-secondary">
            ...
            <?php if($land->documents->count() > 0): ?>
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Documents (<?php echo e($land->documents->count()); ?>)</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $land->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                            ...
                                            <td><?php echo e($document->description ?? 'N/A'); ?></td>
                                            <td><?php echo e($document->uploader->name ?? 'Unknown'); ?></td>
...
<div class="modal fade" id="uploadDocumentModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('lands.store-document', $land)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pprhl\cls_management\resources\views/lands/documents.blade.php ENDPATH**/ ?>