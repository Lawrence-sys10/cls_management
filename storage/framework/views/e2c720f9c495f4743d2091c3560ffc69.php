...
<?php $__env->startSection('title', 'Delete Client - ' . $client->name); ?>
            ...
            <div class="card border-danger">
                <div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-exclamation-triangle me-2"></i>Delete Client - <?php echo e($client->name); ?>

                    </h5>
                    <a href="<?php echo e(route('chief.clients.show', $client)); ?>" class="btn btn-sm btn-light">
                ...
                <div class="card-body">
                                ...
                                <div class="card-body">
                                    <table class="table table-sm table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($client->email ?? 'Not provided'); ?></td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if($allocationCount > 0): ?>
                                        <div class="alert alert-warning p-2 mb-2">
                                            ...
                                            <strong><?php echo e($allocationCount); ?> Land Allocation(s)</strong> will be affected
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if($documentCount > 0): ?>
                                        <div class="alert alert-warning p-2 mb-2">
                                            ...
                                            <strong><?php echo e($documentCount); ?> Document(s)</strong> will be deleted
                                        </div>
                                    <?php endif; ?>
                                    
                                    <?php if($allocationCount == 0 && $documentCount == 0): ?>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <div class="form-text text-muted">
                                    Type: <code><?php echo e($client->name); ?></code>
                                </div>
                            </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <a href="<?php echo e(route('chief.clients.show', $client)); ?>" class="btn btn-success">
                                <i class="fas fa-arrow-left me-2"></i>Go Back Safely
                            </a>
                            
                            <a href="<?php echo e(route('chief.clients.edit', $client)); ?>" class="btn btn-outline-primary ms-2">
                                <i class="fas fa-edit me-2"></i>Edit Instead
                            </a>
                        </div>
                        
                        <div>
                            <form action="<?php echo e(route('chief.clients.destroy', $client)); ?>" method="POST" id="deleteForm">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="row text-center">
                        <div class="col-6 mb-3">
                            <div class="border rounded p-3">
                                <div class="h4 text-primary mb-1"><?php echo e($client->allocations()->count()); ?></div>
                                <small class="text-muted">Land Allocations</small>
                            </div>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="border rounded p-3">
                                <div class="h4 text-info mb-1"><?php echo e($client->documents()->count()); ?></div>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('chief.clients.edit', $client)); ?>" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-edit me-2"></i>Edit Client Information
                        </a>
                        
                        <a href="<?php echo e(route('chief.clients.allocations', $client)); ?>" class="btn btn-outline-info btn-sm">
                            <i class="fas fa-handshake me-2"></i>Manage Allocations
                        </a>

                        <a href="<?php echo e(route('chief.clients.documents', $client)); ?>" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="card mt-4 border-info">
                ...
                <div class="card-body">
                    <div class="mb-2">
                        ...
                        <span class="text-muted"><?php echo e($client->id); ?></span>
                    </div>
                    <div class="mb-2">
                        <strong>Created:</strong>
                        <span class="text-muted"><?php echo e($client->created_at->format('M j, Y g:i A')); ?></span>
                    </div>
                    <div class="mb-2">
                        <strong>Last Updated:</strong>
                        <span class="text-muted"><?php echo e($client->updated_at->format('M j, Y g:i A')); ?></span>
                    </div>
                    <div class="mb-2">
                        <strong>Last Login:</strong>
                        <span class="text-muted">
                            <?php if($client->last_login_at): ?>
                                <?php echo e($client->last_login_at->format('M j, Y g:i A')); ?>
...
<script>
    function toggleDeleteButton() {
        const clientName = "<?php echo e($client->name); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pprhl\cls_management\resources\views/chiefs/clients/delete.blade.php ENDPATH**/ ?>