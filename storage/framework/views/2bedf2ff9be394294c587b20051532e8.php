...
<?php $__env->startSection('title', 'Client Details - ' . $client->full_name); ?>
        ...
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center py-3">
                    ...
                    <div class="btn-group">
                        <a href="<?php echo e(route('chief.clients.edit', $client)); ?>" class="btn btn-sm btn-outline-secondary">
                            <i class="fas fa-edit me-1"></i>Edit
                        </a>
                        <a href="<?php echo e(route('chief.clients.index')); ?>" class="btn btn-sm btn-outline-primary">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="client-avatar-large mb-3">
                                <div class="avatar-circle-large bg-primary text-white">
                                    <?php echo e(substr($client->full_name, 0, 1)); ?>

                                </div>
                            </div>
                            <h6 class="mb-1 fw-bold"><?php echo e($client->full_name); ?></h6>
                            <small class="text-muted d-block">Client ID: <?php echo e($client->id); ?></small>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="detail-group">
                                        ...
                                        <p class="detail-value"><?php echo e($client->id_number); ?></p>
                                    </div>
                                    <div class="detail-group">
                                        <label class="detail-label">ID Type</label>
                                        <p class="detail-value"><?php echo e($client->id_type_formatted); ?></p>
                                    </div>
                                    <div class="detail-group">
                                        <label class="detail-label">Date of Birth</label>
                                        <p class="detail-value">
                                            <?php if($client->date_of_birth): ?>
                                                <?php echo e(\Carbon\Carbon::parse($client->date_of_birth)->format('M j, Y')); ?>

                                                <small class="text-muted d-block">(<?php echo e($client->age); ?> years)</small>
                                            <?php else: ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="detail-group">
                                        ...
                                        <p class="detail-value">
                                            <?php if($client->phone): ?>
                                                <a href="tel:<?php echo e($client->phone); ?>" class="text-decoration-none">
                                                    <i class="fas fa-phone me-1 text-muted"></i><?php echo e($client->phone); ?>
                                    ...
                                    <div class="detail-group">
                                        ...
                                        <p class="detail-value">
                                            <?php if($client->email): ?>
                                                <a href="mailto:<?php echo e($client->email); ?>" class="text-decoration-none">
                                                    <i class="fas fa-envelope me-1 text-muted"></i><?php echo e($client->email); ?>
                                    ...
                                    <div class="detail-group">
                                        ...
                                        <p class="detail-value">
                                            <?php if($client->gender): ?>
                                                <?php echo e(ucfirst($client->gender)); ?>
                                            ...
                                            <div class="detail-group">
                                                ...
                                                <p class="detail-value">
                                                    <?php if($client->emergency_contact): ?>
                                                        <?php echo e($client->emergency_contact); ?>
                                ...
                                <div class="col-12">
                                    <div class="detail-group">
                                        ...
                                        <p class="detail-value"><?php echo e($client->address); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="col-12">
                                    <div class="detail-group">
                                        ...
                                        <p class="detail-value text-muted"><?php echo e($client->notes); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            <div class="detail-group">
                                                ...
                                                <p class="detail-value"><?php echo e($client->created_at->format('M j, Y g:i A')); ?></p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="detail-group">
                                                <label class="detail-label">Last Updated</label>
                                                <p class="detail-value"><?php echo e($client->updated_at->format('M j, Y g:i A')); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="card">
                <div class="card-header py-3">
                    <h6 class="card-title mb-0">
                        ...
                        <span class="badge bg-primary ms-2"><?php echo e($client->allocations->count()); ?></span>
                    </h6>
                </div>
                <div class="card-body p-3">
                    <div class="table-responsive">
                        <table class="table table-sm table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ps-3">
                                        <a href="<?php echo e(route('chief.lands.show', $allocation->land)); ?>" class="text-decoration-none fw-semibold">
                                            <?php echo e($allocation->land->plot_number); ?>

                                        </a>
                                    </td>
                                    <td class="text-truncate" style="max-width: 150px;" title="<?php echo e($allocation->land->location); ?>">
                                        <?php echo e($allocation->land->location); ?>

                                    </td>
                                    <td><?php echo e(\Carbon\Carbon::parse($allocation->allocation_date)->format('M j, Y')); ?></td>
                                    <td><?php echo e($allocation->duration_years); ?> years</td>
                                    <td class="pe-3">
                                        <span class="badge <?php echo e($allocation->status == 'active' ? 'bg-success' : 'bg-secondary'); ?>">
                ...
                <div class="card-body p-3">
                    <div class="stats-grid">
                        <div class="stat-item text-center p-2">
                            <div class="stat-value text-primary"><?php echo e($client->allocations->count()); ?></div>
                            <div class="stat-label">Total Allocations</div>
                        </div>
                        <div class="stat-item text-center p-2">
                            <div class="stat-value text-success"><?php echo e($client->allocations->where('status', 'active')->count()); ?></div>
                    ...
                    <div class="timeline-info">
                        <div class="timeline-item d-flex align-items-center mb-2">
                            ...
                            <div>
                                ...
                                <div class="fw-semibold"><?php echo e($client->created_at->format('M j, Y')); ?></div>
                            </div>
                        </div>
                        <div class="timeline-item d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="fw-semibold"><?php echo e($client->updated_at->format('M j, Y')); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pprhl\cls_management\resources\views/chiefs/clients/show.blade.php ENDPATH**/ ?>