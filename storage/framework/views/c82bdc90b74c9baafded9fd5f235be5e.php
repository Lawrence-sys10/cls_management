...
<head>
    <meta charset="utf-8">
    <title>Allocation Certificate - <?php echo e($allocation->land->plot_number); ?></title>
    <style>
    ...
    <div class="certificate">
        ...
        <div class="content">
            <div class="section">
                ...
                <h3><?php echo e($allocation->client->name); ?></h3>
            ...
            <div class="section">
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td><?php echo e($allocation->land->plot_number); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($allocation->land->area_acres); ?> acres</td>
                    </tr>
                    <tr>
                        <td><strong>Allocation Date:</strong></td>
                        <td><?php echo e($allocation->allocation_date->format('F j, Y')); ?></td>
                    </tr>
                    <tr>
        ...
        <div class="signature">
            <div style="float: right;">
                ...
                <p><strong><?php echo e($allocation->chief->name); ?></strong><br>
                Chief<br>
                Date: <?php echo e(now()->format('F j, Y')); ?></p>
            </div>
        ...
        <div class="footer">
            ...
            <p>Certificate ID: ALLOC-<?php echo e($allocation->id); ?>-<?php echo e($allocation->created_at->format('Ymd')); ?></p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\pprhl\cls_management\resources\views/allocations/certificate.blade.php ENDPATH**/ ?>