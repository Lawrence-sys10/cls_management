...
@section('subtitle', 'Welcome to CLS Management System')
    ...
    <div class="stats-grid mb-4">
        <div class="stat-card lands">
            <div class="stat-header">
                <div class="stat-info">
                    <h3>Total Lands</h3>
                    <div class="stat-value">{{ $stats['total_lands'] ?? 0 }}</div>
                    <div class="stat-trend trend-up">
                        <i class="fas fa-arrow-up"></i>
                        <span>{{ $stats['verified_lands'] ?? 0 }} verified</span>
                    </div>
                </div>
                <div class="stat-icon">
        ...
        <div class="stat-card chiefs">
            <div class="stat-header">
                <div class="stat-info">
                    <h3>Total Chiefs</h3>
                    <div class="stat-value">{{ $stats['total_chiefs'] ?? 0 }}</div>
                    <div class="stat-trend trend-up">
                        <i class="fas fa-arrow-up"></i>
        ...
        <div>
            ...
            <div class="activity-list">
                <div class="activity-header">
                    ...
                    <a href="{{ route('allocations.index') }}" class="btn btn-outline">View All</a>
                </div>
                ...
                <div class="activity-item">
                    ...
                    <div class="activity-content">
                        <div class="activity-text">
                            <strong>{{ $allocation->land->plot_number ?? 'N/A' }}</strong> allocated to 
                            <strong>{{ $allocation->client->full_name ?? 'N/A' }}</strong>
                        </div>
                        <div class="activity-time">{{ $allocation->created_at->diffForHumans() }}</div>
                ...
                <div class="text-center py-4">
                    ...
                    <a href="{{ route('allocations.create') }}" class="btn btn-primary btn-sm mt-2">
            ...
            <div class="quick-actions">
                ...
                <div class="actions-grid">
                    <a href="{{ route('lands.create') }}" class="action-item">
                    ...
                    <a href="{{ route('allocations.create') }}" class="action-item">
                        <div class="action-icon">
                            <i class="fas fa-handshake"></i>
                        </div>
                    ...
                    <a href="{{ route('chiefs.create') }}" class="action-item">
                        <div class="action-icon">
                            <i class="fas fa-crown"></i>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 text-center mb-3">
                            <div class="status-item">
                                ...
                                <span class="badge bg-success">{{ $stats['approved_allocations'] ?? 0 }}</span>
                            </div>
                        </div>
                        <div class="col-md-3 text-center mb-3">
                            <div class="status-item">
                                ...
                                <span class="badge bg-warning">{{ $stats['pending_approvals'] ?? 0 }}</span>
                            </div>
                        </div>
                        <div class="col-md-3 text-center mb-3">
                            <div class="status-item">
                                ...
                                <span class="badge bg-danger">{{ $stats['rejected_allocations'] ?? 0 }}</span>
                            </div>
                        </div>
                        <div class="col-md-3 text-center mb-3">
                            <div class="status-item">
                                ...
                                <span class="badge bg-info">{{ $stats['total_users'] ?? 0 }}</span>
                            </div>
                        </div>
                    </div>
                </div>
