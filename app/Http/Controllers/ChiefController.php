...
class ChiefController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        Chief::create(array_merge($validated, [
    ...
    public function update(Request $request, Chief $chief): RedirectResponse
    {
        ...
        $chief->update(array_merge($validated, [
            'is_active' => $request->boolean('is_active', $chief->is_active)
        ]));
    ...
    public function getChiefStats(): JsonResponse
    {
    ...
    public function allocations(Chief $chief): View
    {
        $allocations = Allocation::with(['client', 'land'])
            ->where('chief_id', $chief->id)
            ->latest()
        ...
        return view('chiefs.allocations', compact('chief', 'allocations'));
    }
